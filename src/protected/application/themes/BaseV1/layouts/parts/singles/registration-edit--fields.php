        ...
        <li ng-repeat="field in data.fields" ng-if="showFieldForCategory(field)" on-repeat-done="registration-fields" class="attachment-list-item registration-edit-mode attachment-list-item-type-{{field.fieldType}}">
            <div ng-show="field.fieldType !== 'file'" id="registration-field-{{field.id}}" >
                ...
                <p ng-if="field.fieldType === 'textarea'" style="position: relative;">
                    <span class='js-editable-field js-include-editable' id="{{field.fieldName}}" data-name="{{field.fieldName}}" data-type="textarea" data-tpl="<textarea onkeyup='console.log(this);charCounter(this);' data-target='{{field.id}}' maxlength='{{ !field.maxSize ?'': field.maxSize }}'></textarea><span id='charCounter_field_{{field.id}}'></span>" data-original-title="{{field.title}}" data-maxlength="{{ field.maxSize }}"  data-emptytext="<?php \MapasCulturais\i::esc_attr_e("Informe");?>" data-value="{{entity[field.fieldName]}}">{{entity[field.fieldName]}}</span>
                </p>
                <p ng-if="field.fieldType === 'text'">
                    <span class='js-editable-field js-include-editable' id="{{field.fieldName}}" data-name="{{field.fieldName}}" data-type="text"  data-tpl="<input onkeyup='console.log(this);charCounter(this);' data-target='{{field.id}}' maxlength='{{ !field.maxSize ?'': field.maxSize }}'></input><span id='charCounter_field_{{field.id}}'></span>" data-original-title="{{field.title}}" data-emptytext="<?php \MapasCulturais\i::esc_attr_e("Informe");?>" data-value="{{entity[field.fieldName]}}">{{entity[field.fieldName]}}</span>
                </p>
